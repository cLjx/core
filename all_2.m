...
for guiji=1:10
    ...
    clearvars -EXCEPT Out1 Out guiji guijiL guijiMH guijiE guijiU ...
        f sita x y Sita ex ey Location SSita res ffff
...
res(SSita,:)=[guiji 32.45+20*log10(guijiL)+20*log10(f/10^6)+guijiU-150];
%     end%ffffffffffffffffffffffffffff
end%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5


% res(Location,:)=[ex 32.45+20*log10(guijiL)+20*log10(f/10^6)+guijiU]
end
